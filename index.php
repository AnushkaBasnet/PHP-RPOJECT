...
<div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="R.jpeg" alt="Deerwalk" width="1500" height="600">
        </div>
        <div class="carousel-item">
            <img src="deerwalk.jpg" alt="NEW FASHION" width="1500" height="600">
        </div>
        <div class="carousel-item">
            <img src="R%20(1).jpeg" alt="STEP INTO SAVINGS" width="1500" height="600">
        </div>
    </div>
...
<section class="my-5">
    <div class="py-5">
        <div class="container-fluid belt-a pt-4 mt-4 bg-success">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                <img src="maxresdefault.jpg" class="img-fluid aboutimg">
            </div>
            <div class="col-lg-6 col-md-6 col-12">
